...
public class BlockLayerPancake extends BlockLayerBase {
    ...
    public boolean onBlockRightClicked(World world, int x, int y, int z, EntityPlayer player, Side side, double xPlaced, double yPlaced) {
        if (player.getHeldItem() != null && player.getHeldItem().getItem() == BTBItems.syrupJar){
            world.setBlockAndMetadataWithNotify(x,y,z, BTBBlocks.layerPancakeSyrup.id,world.getBlockMetadata(x,y,z));
